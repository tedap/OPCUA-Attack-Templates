...
class Client:
    ...
    def __init__(self, url: str, timeout: float = 120, watchdog_intervall: float = 1.0):
        """
    ...
    async def connect_socket(self, port) -> None:
        """
        connect to socket defined in url
        """

        await self.uaclient.connect_socket(self.server_url.hostname, self.server_url.port, src_port=port)
